...
class ConversationDBService {
  ...
  Future<List<ConversationGroup>> getAllConversationGroups() async {
    ...
    List<ConversationGroup> conversationGroupList = recordSnapshots.map((snapshot) {
      ...
      print("snapshot.key: " + snapshot.key.toString()); // The instructor said snapshot.key is uniquely generated by Sembast DB. // TODO: What about the same thing generated by MongoDB?
