...
class MultimediaAPIService {
  ...
  Future<Multimedia> addMultimedia(Multimedia multimedia) async {
    ...
    var httpResponse = await http.post(wholeURL, body: multimediaJsonString, headers: createAcceptJSONHeader());
  ...
  Future<bool> editMultimedia(Multimedia multimedia) async {
    String multimediaJsonString = json.encode(multimedia.toJson());
    return httpResponseIsOK(await http.put("$REST_URL/$multimediaAPI", body: multimediaJsonString, headers: createAcceptJSONHeader()));
  }

  Future<bool> deleteMultimedia(String multimediaId) async {
    var httpResponse = await http.delete("$REST_URL/$multimediaAPI/$multimediaId");
    return httpResponseIsOK(httpResponse);
  }

  Future<Multimedia> getSingleMultimedia(String multimediaId) async {
    return getMultimediaBody(await http.get("$REST_URL/$multimediaAPI/$multimediaId"));
  }

  Future<Multimedia> getMultimediaOfAUser(String userId) async {
    return getMultimediaBody(await http.get("$REST_URL/$multimediaAPI/user/$userId"));
  }

  Future<Multimedia> getMultimediaOfAUserContact(String userContactId) async {
    return getMultimediaBody(await http.get("$REST_URL/$multimediaAPI/userContact/$userContactId"));
  }

  Future<Multimedia> getConversationGroupPhotoMultimedia(String conversationGroupId) async {
    return getMultimediaBody(await http.get("$REST_URL/$multimediaAPI/conversationGroup/photo/$conversationGroupId"));
  }
  ...
  Future<Multimedia> getMessageMultimedia(String conversationGroupId, String messageId) async {
    return getMultimediaBody(await http.get("$REST_URL/$multimediaAPI/message/$conversationGroupId/$messageId"));
  }

  Future<List<Multimedia>> getAllMultimediaOfAConversationGroup(String conversationGroupId) async {
    return getMultimediaListBody(await http.get("$REST_URL/$multimediaAPI/conversationGroup/$conversationGroupId"));
  }
